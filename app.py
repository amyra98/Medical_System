...
model2 = load_model('/home/priti/Downloads/AI-based-Healthcare-Chatbot-and-Disease-Detection-System-main\\model.h5')

import json
import random
intents = json.loads(open('/home/priti/Downloads/AI-based-Healthcare-Chatbot-and-Disease-Detection-System-main\\data.json').read())
words = pickle.load(open('/home/priti/Downloads/AI-based-Healthcare-Chatbot-and-Disease-Detection-System-main\\texts.pkl','rb'))
classes = pickle.load(open('/home/priti/Downloads/AI-based-Healthcare-Chatbot-and-Disease-Detection-System-main\\labels.pkl','rb'))
...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:////home/priti/Downloads/AI-based-Healthcare-Chatbot-and-Disease-Detection-System-main/database.db'
